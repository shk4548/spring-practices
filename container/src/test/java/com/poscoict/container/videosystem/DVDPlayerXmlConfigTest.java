...
public class DVDPlayerXmlConfigTest {
	...
	public void testDvd3() {
		assertNotNull(dvd3); // not null 단언
	}
	
	@Test
	public void testDvd4() {
		assertNotNull(dvd4); // not null 단언
	}
	
	@Test
	public void testDvd5() {
		assertNotNull(dvd5); // not null 단언
	}
	
	@Test
	public void testDvd6() {
		assertNotNull(dvd6); // not null 단언
	}
	
	@Test
	public void testDvd7() {
		assertNotNull(dvd7); // not null 단언
	}
	
	@Test
	public void testDvd8() {
		assertNotNull(dvd8); // not null 단언
	}
	
	@Test
	public void testDvd9() {
		assertNotNull(dvd9); // not null 단언
	}
	
	@Test
	public void testDvd10() {
		assertNotNull(dvd10); // not null 단언
	}
	
	@Test
	public void testDvdPack() {
		assertNotNull(dvdPack); // not null 단언
	}
